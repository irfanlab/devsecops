...
docker run --rm -v /var/run/docker.sock:/var/run/docker.sock -v $HOME/Library/Caches:/root/.cache/ aquasec/trivy:v0.69.3 -q image --exit-code 0 --severity HIGH --light $dockerImageName
